...
cliff_eff_count
#0 means data overlap, 1 means no overlap
...
```{r}
#1 compare IVEE and Naples REEF lobster sizes, 2012 and 2017

#create data file with the years of interest and grouped by site
size_2012_2017 = size_case %>% 
  filter(SIZE != "-99999", YEAR == "2017"| YEAR == "2012") %>% 
  group_by(SITE)

#variance test
#from previous table, largest variance does not exceed 4x smallest variance

#ANOVA 
size_2012_2017_aov = aov(SIZE ~ SITE, data = size_2017)
size_2012_2017_aov


#Tukey's HSD
TukeyHSD(size_2012_2017_aov)
