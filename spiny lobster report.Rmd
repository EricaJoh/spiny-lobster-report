...
#ANOVA 
as.factor(size_2017$YEAR)

size_2012_2017_aov = aov(YEAR~SITE, data = size_2017)
summary(size_2012_2017_aov)
#p-value 0.0085 is below the significance level 0.05. At least one mean is significanlty different.
